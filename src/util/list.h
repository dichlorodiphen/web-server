...
#define list_empty(list) ((list)->l_next == (list))
...
#define list_insert_head(list, link) list_insert_before((list)->l_next, link)

#define list_insert_tail(list, link) list_insert_before(list, link)
...
#define list_remove_head(list) list_remove((list)->l_next)

#define list_remove_tail(list) list_remove((list)->l_prev)
